...
## Data preparation
# source(system.file("tuto-helper/R/libs.R", package = "eNFI"), local = T)
# source(system.file("tuto-helper/R/load-fonts.R", package = "eNFI"), local = T)
# source(system.file("tuto-helper/R/data-preparation.R", package = "eNFI"), local = T)
